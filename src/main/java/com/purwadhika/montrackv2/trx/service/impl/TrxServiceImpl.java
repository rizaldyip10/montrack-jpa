package com.purwadhika.montrackv2.trx.service.impl;

import com.pwdk.montrackgrpc.lib.CurrencyExchangeGrpc.CurrencyExchangeBlockingStub;
...
import com.purwadhika.montrackv2.trx.repository.TrxRepository;
import com.purwadhika.montrackv2.trx.service.TrxService;
import com.purwadhika.montrackv2.users.service.UserService;
import com.pwdk.montrackgrpc.lib.CurrencyExchangeGrpc;
import com.pwdk.montrackgrpc.lib.ExchangeRequest;
import com.pwdk.montrackgrpc.lib.ExchangeResponse;
...
public class TrxServiceImpl implements TrxService {
    private final TrxRepository trxRepo;
    ...
    public TrxServiceImpl(TrxRepository trxRepo, UserService userService) {
            ...
            if (!Objects.equals(trx.getCurrency().getId(), user.getCurrency().getId())) {
                ...
                try {
                    ...
                    ExchangeRequest request = ExchangeRequest.newBuilder()
                            .setAmount(Double.parseDouble(trx.getValue().toString()))
